...
//            }
            ...
            if (States.userIp != localIp) {
                States.ticketUrl = "http://14.146.227.141:7001/ticket.cgi?wlanacip=${States.acIp}&wlanuserip=${States.userIp}&clientip=${States.userIp}&wlanacname=SISE&clientmac=b8:fd:12:22:ab:e0&paip=10.88.88.88&vlan=100.0&iarmdst=connect.rom.miui.com/generate_204&portal_node=http://125.88.59.131:10002"
                States.authUrl = "http://14.146.227.141:7001/auth.cgi"
                // 如果本机IP与States.userIp不同，返回需要认证
                return ConnectivityStatus.REQUIRE_AUTHORIZATION
            }
