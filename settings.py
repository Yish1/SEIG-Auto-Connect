...
class Ui_sac_settings(object):
    def setupUi(self, sac_settings):
        ...
        sac_settings.setMinimumSize(QtCore.QSize(240, 408))
...
"}")
        ...
        self.pushButton_7.setMinimumSize(QtCore.QSize(0, 150))
...
"")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/donate.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_7.setIcon(icon)
        self.pushButton_7.setIconSize(QtCore.QSize(150, 150))
    ...
    def retranslateUi(self, sac_settings):
        ...
        self.label_5.setText(_translate("sac_settings", "<html><head/><body><p><span style=\" font-size:11pt;\">感谢您使用虚空终端！</span></p><p><span style=\" font-size:11pt;\">项目地址:</span><a href=\"https://github.com/Yish1/SEIG-Auto-Connect\"><span style=\" text-decoration: underline; color:#0000ff;\">github.com/Yish1/SEIG-Auto-Connect</span></a></p><p><span style=\" font-size:11pt;\">注：请不要在任何大型社交平台讨论此工具！</span></p><p><span style=\" font-size:11pt;\">Buy me a coffee :)</span></p></body></html>"))
